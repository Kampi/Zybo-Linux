...
#
# Generated by Vivado on Sat Apr 11 15:26:33 CEST 2020
...
set _xil_proj_name_ "SimpleLinux"
...
set_property -name "compxlib.xcelium_compiled_library_dir" -value "/home/kampi/Schreibtisch/Git/Zybo-Linux/vivado/SimpleLinux/ZyboLinux/ZyboLinux.cache/compile_simlib/xcelium" -objects $obj
...
proc cr_bd_System { parentCell } {
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins AXILite_Peripherals/M00_AXI] [get_bd_intf_pins Button/S_AXI]

  # Create port connections
  connect_bd_net -net Net [get_bd_pins AXILite_Peripherals/ACLK] [get_bd_pins AXILite_Peripherals/M00_ACLK] [get_bd_pins AXILite_Peripherals/S00_ACLK] [get_bd_pins Button/s_axi_aclk] [get_bd_pins ProcessingSystem/FCLK_CLK0] [get_bd_pins ProcessingSystem/M_AXI_GP0_ACLK] [get_bd_pins Reset_ProcessingSystem/slowest_sync_clk]
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins AXILite_Peripherals/ARESETN] [get_bd_pins Reset_ProcessingSystem/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins AXILite_Peripherals/M00_ARESETN] [get_bd_pins AXILite_Peripherals/S00_ARESETN] [get_bd_pins Button/s_axi_aresetn] [get_bd_pins Reset_ProcessingSystem/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins ProcessingSystem/FCLK_RESET0_N] [get_bd_pins Reset_ProcessingSystem/ext_reset_in]

  # Create address segments
  assign_bd_address -offset 0x41200000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ProcessingSystem/Data] [get_bd_addr_segs Button/S_AXI/Reg] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.696226",
   "Default View_TopLeft":"-289,-79",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0.21  2019-05-29 bk=1.5064 VDI=41 GEI=36 GUI=JA:9.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1020 -y 250 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1020 -y 270 -defaultsOSRD
preplace port Button -pg 1 -lvl 4 -x 1020 -y 0 -defaultsOSRD
preplace inst Reset_ProcessingSystem -pg 1 -lvl 1 -x 230 -y 110 -defaultsOSRD
preplace inst ProcessingSystem -pg 1 -lvl 1 -x 230 -y 320 -defaultsOSRD
preplace inst AXILite_Peripherals -pg 1 -lvl 2 -x 620 -y 130 -defaultsOSRD
preplace inst Button -pg 1 -lvl 3 -x 890 -y 0 -defaultsOSRD
preplace netloc Net 1 0 3 20 0 450 0 N
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 10 430
preplace netloc proc_sys_reset_0_peripheral_aresetn 1 1 2 470 10 770
preplace netloc proc_sys_reset_0_interconnect_aresetn 1 1 1 440 110n
...
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 460 70n
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 780 -20n
preplace netloc axi_gpio_0_GPIO 1 3 1 N 0
levelinfo -pg 1 0 230 620 890 1020
pagesize -pg 1 -db -bbox -sgen 0 -80 1140 550
"
}
