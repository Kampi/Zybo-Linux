...
HD_PWD='/home/daniel/Schreibtisch/Git/Zybo-Linux/Vivado/SimpleLinux/SimpleLinux.runs/ProcessingSystem_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ProcessingSystem_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ProcessingSystem_proc_sys_reset_0_0.tcl
