...
HD_PWD='/home/daniel/Schreibtisch/Git/Zybo-Linux/Vivado/SimpleLinux/SimpleLinux.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ProcessingSystem_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ProcessingSystem_wrapper.tcl -notrace
