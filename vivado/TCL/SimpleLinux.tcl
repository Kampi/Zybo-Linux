...
#
# SimpleLinux.tcl: Tcl script for re-creating project 'SimpleLinux'
#
# Generated by Vivado on Wed Apr 04 18:08:37 CEST 2018
...
#
# 1. This project restoration tcl script (SimpleLinux.tcl) that was generated.
#
...
set script_file "SimpleLinux.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../SimpleLinux"]"
...
set files [list \
 "[file normalize "$origin_dir/../SimpleLinux/SimpleLinux.srcs/sources_1/bd/ProcessingSystem/hdl/ProcessingSystem_wrapper.vhd"]"\
]
...
set file "hdl/ProcessingSystem_wrapper.vhd"
...
set_property -name "top" -value "ProcessingSystem_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/../SimpleLinux/SimpleLinux.srcs/constrs_1/new/SimpleLinux.xdc"]"
set file_imported [import_files -fileset constrs_1 $file]
set file "new/SimpleLinux.xdc"
...
set_property -name "target_constrs_file" -value "[get_files *new/SimpleLinux.xdc]" -objects $obj
...
# Proc to create BD ProcessingSystem
proc cr_bd_ProcessingSystem { parentCell } {
  ...
  # Create instance: AXI_GPIO_Taster, and set properties
  set AXI_GPIO_Taster [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 AXI_GPIO_Taster ]
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports GPIO] [get_bd_intf_pins AXI_GPIO_Taster/GPIO]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins AXI_GPIO_Taster/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net Net [get_bd_pins AXI_GPIO_Taster/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins AXI_GPIO_Taster/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AXI_GPIO_Taster/S_AXI/Reg] SEG_axi_gpio_0_Reg
...
# End of cr_bd_ProcessingSystem()
cr_bd_ProcessingSystem ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files ProcessingSystem.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files ProcessingSystem.bd ] 
set_property IS_ENABLED "1" [get_files ProcessingSystem.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files ProcessingSystem.bd ] 
set_property IS_LOCKED "0" [get_files ProcessingSystem.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files ProcessingSystem.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files ProcessingSystem.bd ] 
set_property PFM_NAME "" [get_files ProcessingSystem.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files ProcessingSystem.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files ProcessingSystem.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files ProcessingSystem.bd ] 
set_property USED_IN_SIMULATION "1" [get_files ProcessingSystem.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files ProcessingSystem.bd ] 
