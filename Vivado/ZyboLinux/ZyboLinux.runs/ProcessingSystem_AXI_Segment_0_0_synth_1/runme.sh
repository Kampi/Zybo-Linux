...
HD_PWD='/home/daniel/Schreibtisch/Git/Zybo-Linux/Vivado/ZyboLinux/ZyboLinux.runs/ProcessingSystem_AXI_Segment_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ProcessingSystem_AXI_Segment_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ProcessingSystem_AXI_Segment_0_0.tcl
