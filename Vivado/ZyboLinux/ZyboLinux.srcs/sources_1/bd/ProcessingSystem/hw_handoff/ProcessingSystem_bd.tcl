...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set Anode [ create_bd_port -dir O -from 6 -to 0 Anode ]
  set Segment [ create_bd_port -dir O Segment ]

  # Create instance: AXI_Segment_0, and set properties
  set AXI_Segment_0 [ create_bd_cell -type ip -vlnv www.kampis-elektroecke.de:Kampis-Elektroecke:AXI_Segment:1.1 AXI_Segment_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_IMPORT_BOARD_PRESET {/home/daniel/Schreibtisch/Git/Zybo-Linux/Vivado/Zybo.xml} \
  ...
  # Create instance: SystemReset, and set properties
  set SystemReset [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 SystemReset ]
  ...
  connect_bd_intf_net -intf_net Buttons_GPIO [get_bd_intf_ports Button] [get_bd_intf_pins Buttons/GPIO]
  ...
  connect_bd_intf_net -intf_net ProcessingSystem_IIC_0 [get_bd_intf_ports IIC_0_0] [get_bd_intf_pins ProcessingSystem/IIC_0]
  connect_bd_intf_net -intf_net Switches_GPIO [get_bd_intf_ports Switch] [get_bd_intf_pins Switches/GPIO]
  connect_bd_intf_net -intf_net Vaux14_0_1 [get_bd_intf_ports Vaux14] [get_bd_intf_pins XADC/Vaux14]
  connect_bd_intf_net -intf_net Vaux15_0_1 [get_bd_intf_ports Vaux15] [get_bd_intf_pins XADC/Vaux15]
  connect_bd_intf_net -intf_net Vaux6_0_1 [get_bd_intf_ports Vaux6] [get_bd_intf_pins XADC/Vaux6]
  connect_bd_intf_net -intf_net Vaux7_0_1 [get_bd_intf_ports Vaux7] [get_bd_intf_pins XADC/Vaux7]
  connect_bd_intf_net -intf_net Vp_Vn_0_1 [get_bd_intf_ports Vp_Vn] [get_bd_intf_pins XADC/Vp_Vn]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins ProcessingSystem/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins Switches/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins AXI_Segment_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins XADC/s_axi_lite] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]

  # Create port connections
  connect_bd_net -net AXI_Segment_0_Anode [get_bd_ports Anode] [get_bd_pins AXI_Segment_0/Anode]
  connect_bd_net -net AXI_Segment_0_Segment [get_bd_ports Segment] [get_bd_pins AXI_Segment_0/Segment]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AXI_Segment_0/s_axi_aclk] [get_bd_pins Buttons/s_axi_aclk] [get_bd_pins ProcessingSystem/FCLK_CLK0] [get_bd_pins ProcessingSystem/M_AXI_GP0_ACLK] [get_bd_pins Switches/s_axi_aclk] [get_bd_pins SystemReset/slowest_sync_clk] [get_bd_pins XADC/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins ProcessingSystem/FCLK_RESET0_N] [get_bd_pins SystemReset/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins SystemReset/interconnect_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins AXI_Segment_0/s_axi_aresetn] [get_bd_pins Buttons/s_axi_aresetn] [get_bd_pins Switches/s_axi_aresetn] [get_bd_pins SystemReset/peripheral_aresetn] [get_bd_pins XADC/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins ProcessingSystem/IRQ_F2P] [get_bd_pins xlconcat_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces ProcessingSystem/Data] [get_bd_addr_segs AXI_Segment_0/S_AXI/S_AXI_reg] SEG_AXI_Segment_0_S_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces ProcessingSystem/Data] [get_bd_addr_segs Buttons/S_AXI/Reg] SEG_Buttons_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces ProcessingSystem/Data] [get_bd_addr_segs Switches/S_AXI/Reg] SEG_Switches_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces ProcessingSystem/Data] [get_bd_addr_segs XADC/s_axi_lite/Reg] SEG_XADC_Reg
