...
HD_PWD='/home/daniel/Schreibtisch/Git/Zybo-Linux/Vivado/SimpleLinux/SimpleLinux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ProcessingSystem_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ProcessingSystem_wrapper.tcl
