...
enum opt_code
{
  ...
  OPT_mandroid = 1185,                       /* -mandroid */
  OPT_mapcs = 1186,                          /* -mapcs */
  OPT_mapcs_float = 1187,                    /* -mapcs-float */
  ...
  OPT_mcpu_ = 1198,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1199,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1200,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1201,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1202,                  /* -mfp16-format= */
  OPT_mfpu_ = 1203,                          /* -mfpu= */
  OPT_mglibc = 1204,                         /* -mglibc */
  /* OPT_mhard_float = 1205, */              /* -mhard-float */
  OPT_mlittle_endian = 1206,                 /* -mlittle-endian */
  OPT_mlong_calls = 1207,                    /* -mlong-calls */
  OPT_mmusl = 1208,                          /* -mmusl */
  OPT_mneon_for_64bits = 1209,               /* -mneon-for-64bits */
  OPT_mnew_generic_costs = 1210,             /* -mnew-generic-costs */
  OPT_mold_rtx_costs = 1211,                 /* -mold-rtx-costs */
  OPT_mpic_data_is_text_relative = 1212,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1213,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1214,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1215,               /* -mprint-tune-info */
